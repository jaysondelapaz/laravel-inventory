...
<div class="row">
<div class="col-md-4 pull-left"><h4>Transaction Details</h4>  <p class="text-muted mb-0">Details of the stock out</p></div>
...
<div class="col-md-4 pull-left">
        ...
        @endif
  		...
  		<div class="col-md-4 pull-left">
			<a href="{{route('Backend.stockout.index')}}" class="btn btn default pull-right" style="border:1px solid green;color:green;">+ All Transactions</a>
  		</div>
</div><!--End of row-->	
		...
		<div class="box box-primary">
            ...
            <div class="box-body">
            	...
            	<div class="form-group row">
                   ...
                   <span class="col-md-8">{{$header->encoder ? $header->encoder->username : 'Unknown'}}</span>
                </div>
              ...
              @if($header->status =='draft')
            	<a href="#" class="btn btn-default pull-left btn-void" data-url="{{route('Backend.stockout.destroy',[$header->id])}}"><i class="icon fa fa-ban"></i> Void</a>
            	<a href="#" class="btn btn-success pull-right btn-approve" data-url="{{route('Backend.stockout.approve',[$header->id])}}">Approve</a>
              @endif
              
              
              <a href="{{route('Backend.stockout.index')}}" class="btn btn-flat" style="margin-top:5px;color:green;">
...
<div class="col-md-8 col-md-offset-1">
  <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Stock Out Form </h3>
        </div>

        <div class="box-body">

          <form class="form" method="post" action="{{route('Backend.stockout.Add-Product',[$header->id])}}">
            {{csrf_field()}}
            <div class="col-md-5">
            ...
            <div class="col-md-3 col-md-offset-1">
                <div class="form-group">
                  <input type="text" class="form-control" name="qty" placeholder="No. of Qty" value="{{old('qty')}}">
                   {{-- @if($errors->has('qty')) <small class="danger text-muted" style="color:red;">{{ $errors->first('qty') }}</small>@endif --}}
                </div>
            </div>
 ...
 <div class='col-md-8 col-md-offset-1'>
   <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <table class="table stockout_tbl" id="stockout_tbl">
            <thead>
            <tr>
              <th>Product</th>
              <th>Supplier</th>
           ...
           <tbody>
            @foreach($details as $index => $detail) <!--$details from edit method inside controller-->
             <tr>
                ...
                <div class="input-group">
                        <div class="input-group-btn">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="#" class="dropdown-item btn-void" data-url="{{route('Backend.stockout.remove-product',[$detail->stock_out_header_id,$detail->id])}}">Remove Product</a></li>
                          </ul>
                        </div>
