...
<div class="row">
    ...
    <span>Record of all deleted suppliers data in your web application.</span>
  </div>
  ...
  <div class="col-md-4 pull-right">
      ...
      <a href="{{route('Backend.supplier.index')}}" class="btn btn default pull-right" style="border:1px solid green;color:green;">All active suppliers</a>
  </div>
...
<div class="row">
	...
	<div class="box">
            ...
            <div class="box-body">
              ...
              <table id="supplier_tbl" class="table table-striped supplier_tbl" width="100%">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Supplier</th>
                      ...
                      <div class="input-group">
                        <div class="input-group-btn">
                          ...
                          <ul class="dropdown-menu">
                            <li><a class="btn-restore" href="#" data-url="{{route('Backend.supplier.restore',[$trash->id])}}">restore</a></li>
...
$(document).ready(function(){
    ...
    $('.supplier_tbl').delegate('.btn-restore','click', function(){
