...
<body>
	...
	<thead>
		<tr>
			...
			<td width="30%" style="border:1px solid #000;text-align:right;font-size:22px;padding:5px;"><strong>{{$header->code}}</strong></td>	
		</tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<thead>
			<tr style="background-color:black;font-size:13px;color:#fff;">
